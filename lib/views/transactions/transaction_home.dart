                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: TextFormField(   decoration: const InputDecoration(
                            labelText: 'Expense Name', enabledBorder: OutlineInputBorder()),),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: TextFormField( initialValue: '100.0',  decoration: const InputDecoration(
                            labelText: 'Cost', enabledBorder: OutlineInputBorder()),),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
